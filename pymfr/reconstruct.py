...
#@torch.jit.script
def _laplacian(potential, peak_sign, poly_order: int, field_line_quantity_coeffs):
...
def _reconstruct_map(magnetic_field_observed,
    ...
    # \mu_0 j_z = -\del^2 A_z
    current_density_unit = 1 / (scipy.constants.mu_0 * pixel_width[..., None, None])  # pA/m^2 if B is in nT and pixel width in km
